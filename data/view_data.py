"""Prints information about the columns and their types in the database.

We used it for an initial exploration of the database structure.
"""
...
if __name__ == "__main__":
    ...
    )  # Cambia "extracted" con il nome della tua tabella
